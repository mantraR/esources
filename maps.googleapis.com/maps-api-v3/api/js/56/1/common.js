google.maps.__gjsload__("common", function (_) {
  ...
  Uda = function (a, b, c) {
    const d = b.Sw(),
      e = b.getMetadata();
    var f = a.Lg && !1;
    f = a.Gg || f ? new _.Xf(new _.pg({ yI: a.Gg, SH: f })) : new _.Xf();
    c += d.Mj();
    ...
    a = c;
    h = new _.Gp({ lj: f, eG: void 0 }, d.Gg);
  ...
  _.Yt = function (a, b, c, d = 0) {
    ...
    if (e && null != f && g) {
      ...
      d = b.Nw({ center: a, zoom: f, tilt: h, heading: l }, e);
      c = Tt(_.Nt(g), c);
      ...
      if (!c && !d && Date.now() < a.Ng + 250)
        ...
        if (a.isActive && (d || 3 !== a.Jg.Mk))
          for (const h of cw(b)) {
            ...
            g = a.lh.Aj.wrap(g);
            f = _.hw(f, g, l);
            const n = a.Jg.OF({ ah: a.Gg, ei: h, BI: f });
            a.Fg.set(e, n);
  ...
  ifa = [_.N, _.P];
  vfa = { cJ: 0, aJ: 1, YI: 2, ZI: 3, WI: 5, XI: 6 };
  tfa = [_.Wp];
  _.It = !1;
  Jt = !1;
  Vfa = class {
  ...
  var pea = class {
    ...
    Wga = class {
      ...
      kl() {}
      Fp() {
        if (this.Fg.Pi.wG && 3 !== this.Jg && this.Fg.Pi.wG(this.Gg))
