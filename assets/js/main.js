...
jQuery(".shortcode_tabs .all_body_cont div:first-child").addClass(
  "active-tabs"
);
jQuery(".shortcode_tabs .all_heads_cont div:first-child").addClass(
  "active-tabs"
);
...
jQuery(".shortcode_tab_item_title").click(function () {
  jQuery(this)
    .parents(".shortcode_tabs")
    .find(".shortcode_tab_item_body")
    .removeClass("active-tabs");
  jQuery(this)
    .parents(".shortcode_tabs")
    .find(".shortcode_tab_item_title")
    .removeClass("active-tabs");
